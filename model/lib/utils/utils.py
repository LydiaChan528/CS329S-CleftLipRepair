...
def save_checkpoint(states, predictions, is_best,
    ...
    if is_best and 'state_dict' in states.keys():
        try:
            torch.save(states['state_dict'].module, os.path.abspath(os.path.join(output_dir, 'model_best.pth')))
        except AttributeError:
            torch.save(states['state_dict'], os.path.abspath(os.path.join(output_dir, 'model_best.pth')))

def save_graphs(train, val, graph_title, output_dir, file_name):
